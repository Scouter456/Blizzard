...
public class QuestRegistry {
    ...
    public static final DeferredRegister<Codec<? extends QuestTypes>> QUEST_TYPE_SERIALIZER = DeferredRegister.create(QuestRegistries.Keys.QUEST_TYPE_SERIALIZERS, MODID);
