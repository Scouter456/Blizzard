...
public class SnowDropParticle extends TextureSheetParticle {
    protected SnowDropParticle(ClientLevel pLevel, double pX, double pY, double pZ) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            SnowDropParticle snowDropParticle = new SnowDropParticle(pLevel, pX, pY, pZ);
            snowDropParticle.pickSprite(this.sprite);
            return snowDropParticle;
        }
    }
}
